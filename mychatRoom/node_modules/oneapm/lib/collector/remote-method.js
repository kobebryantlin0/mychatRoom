...
RemoteMethod.prototype._request = function _request(options) {
    ...
    if(typeof options.body ==='string'){
        requestOptions.headers= this._headers(Buffer.byteLength(options.body, 'utf8'), options.compressed);
    }else{
        requestOptions.headers= this._headers(options.body.length, options.compressed);
    }
